(function (factory) {
  ...
  function CropAvatar($element) {
    ...
    this.$avatarForm = this.$avatarModal.find('.image-form');
    ...
    this.$avatarBtns = this.$avatarForm.find('.image-btns');

    this.$avatarWrapper = this.$avatarModal.find('.image-wrapper');
    this.$avatarPreview = this.$avatarModal.find('.image-preview');
  ...
  CropAvatar.prototype = {
    ...
    ajaxUpload: function () {
     ...
     if(res[3]["avatar_file"]["ContentLength"] > 1048576) {
    	 _this.submitFail("Your image is too big - upload an image with a file size less than 1MB.")
     }
     else {
    	 $.ajax(url, {
    	        type: 'post',
